package graphics.jeux.NoPaintNoGame.src.Perso;
...
//setters
    ...
    public Mario(int largeur, int hauteur, int x, int y) {
        ...
        this.icoMario = new ImageIcon("src/image/personnage.jpg");// quand on créer le fichier jar , le chemin change)
    ...
    public Image saute() {
        ...
        if (this.compteurSaut <= 70) { // Saut est appelé plein de fois, mario Monte, tant que ça ne dépasse pas 35
            ...
            if (this.isVersDroite()) {
                str = "src/image/personnageSautDroit.jpg";
            } else {
                str = "src/image/personnageSautGauche.jpg";
            }
        }
        ...
        //Saut terminé
            ...
            if (this.isVersDroite()) {
                str = "src/image/personnageArretDroit.jpg";
            } else {
                str = "src/image/personnageArretGauche.jpg";
            }
    ...
    public Image meurt() {
        ...
        if (this.compteurMort > 100) {
            str = "src/image/personnageMort.jpg";
